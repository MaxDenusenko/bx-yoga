...
<div class="occupation__form_mobile occupation__form_map">
        ...
        <?if ($arResult["isFormNote"] != "Y")
        {
            ...
            ***********************************************************************************/
            ...
            form questions
             ***********************************************************************************/
            (new WebFormHelper($arResult, SITE_TEMPLATE_PATH, true, true))->getFields();
            ?>
                    ...
                    <div class="form-group checkbox-group">
                        <label>
                            Нажимая на кнопку «Перезвоните мне», я даю согласие на обработку персональных данных и соглашаюсь с условиями политики конфиденциальности
                        </label>
                    </div>
