						...
						<span class="bx-filter-container-modef"></span>
							...
							switch ($arItem["DISPLAY_TYPE"])
							{
								...
								case "P"://DROPDOWN
									...
									?>
                                    <div class="select">
                                        <select class="select-form" data-placeholder="Преподаватель" data-visible-options =1
                                                id="<?=$arItem['CODE']; ?>" name="" onChange="smartFilter.click(this)"  >
                                            <option id="not-value" value="" ><?=$arItem["NAME"]?> (все)</option>
                                            <?foreach($arItem["VALUES"] as $val => $ar) { ?>
